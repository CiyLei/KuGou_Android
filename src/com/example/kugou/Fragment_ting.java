...
public class Fragment_ting extends Fragment implements OnClickListener,TextWatcher,OnPostExecuteListener,OnFocusChangeListener,OnKeyListener,OnItemClickListener {
	...
	Button btn_search;
	LinearLayout linear_frag_ycgq;
	LinearLayout linear_frag_tjgs;
	public static TextView tv_songlist_num;
	LinearLayout linear_frag_local;
	public static LinearLayout line_home_main_hide;
	public static RadioButton radio_home_main_sc;
	public static RadioButton radio_home_main_zp;
	public static RadioButton radio_home_main_xx;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        line_home_main_hide=(LinearLayout) view.findViewById(R.id.line_home_main_hide);
        radio_home_main_sc=(RadioButton) view.findViewById(R.id.radio_home_main_sc);
        radio_home_main_zp=(RadioButton) view.findViewById(R.id.radio_home_main_zp);
        radio_home_main_xx=(RadioButton) view.findViewById(R.id.radio_home_main_xx);
        linear_frag_ycgq=(LinearLayout) view.findViewById(R.id.linear_frag_ycgq);
        linear_frag_tjgs=(LinearLayout) view.findViewById(R.id.linear_frag_tjgs);
		...
		radio_home_main_sc.setOnClickListener(this);
		radio_home_main_zp.setOnClickListener(this);
		radio_home_main_xx.setOnClickListener(this);
		linear_frag_ycgq.setOnClickListener(this);
		linear_frag_tjgs.setOnClickListener(this);
	...
	public void onClick(View v) {
		...
		case R.id.radio_home_main_sc:
			
			if(radio_home_main_sc.getText().equals("上传")){
				Intent intent = new Intent(getActivity(), Upload.class);
				startActivity(intent);
			}else{
				Intent intent = new Intent(getActivity(), Signed_Singer.class);
				startActivity(intent);
			}
			
			break;
			
		case R.id.radio_home_main_zp:
			
			if(radio_home_main_zp.getText().equals("作品")){
				Intent intent = new Intent(getActivity(), Works.class);
				startActivity(intent);
			}else{
				Intent intent = new Intent(getActivity(), Signed_Songs.class);
				startActivity(intent);
			}
			
			break;
			
		case R.id.radio_home_main_xx:
		...
		case R.id.linear_frag_ycgq:
			
			intent = new Intent(getActivity(), Original_Songs.class);
			startActivity(intent);
			
			break;		
			
		case R.id.linear_frag_tjgs:
			
			intent = new Intent(getActivity(), Recommend_Singer.class);
			startActivity(intent);
	...
	public static void login_Refresh() {
		if(Home.user.isLogin){
			if(Home.user.userID.equals("q903736663")){
				line_home_main_hide.setVisibility(View.VISIBLE);
				radio_home_main_sc.setText("上传");
				radio_home_main_zp.setText("作品");
				radio_home_main_xx.setText("消息");
			}
			else if(Home.user.userID.equals("q903736664")){
				line_home_main_hide.setVisibility(View.VISIBLE);
				radio_home_main_sc.setText("已签约歌手");
				radio_home_main_zp.setText("已购买歌曲");
				radio_home_main_xx.setText("消息");
			}
		}
		else{
			line_home_main_hide.setVisibility(View.GONE);
		}
	}
}
